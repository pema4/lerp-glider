...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 236.0, 165.0, 32.0, 22.0 ],
					"text" : "t b 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 131.0, 165.0, 32.0, 22.0 ],
					"text" : "t b 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 450.0, 34.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 375.0, 165.0, 74.0, 22.0 ],
					"text" : "unpack 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 90.0, 90.0, 259.0, 22.0 ],
					"text" : "route bang float int duration"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 660.0, 30.0, 141.0, 22.0 ],
									"text" : "in 4 @comment Duration"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 450.0, 30.0, 129.0, 22.0 ],
									"text" : "in 3 @comment Target"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 345.0, 585.0, 35.0, 22.0 ],
									"text" : "out 2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 705.0, 75.0, 518.0, 74.0 ],
									"text" : "Action:\n0 - do nothing (just advance the ramp)\n1 - instantly restart the ramp with target\n2 - restart the ramp, with target/duration\n3 - change the ramp speed, remaining ramp duration will be scaled according to new duration"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 240.0, 30.0, 129.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 279.5, 435.0, 84.5, 435.0 ],
					"order" : 1,
					"source" : [ "obj-174", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 279.5, 435.0, 174.5, 435.0 ],
					"order" : 0,
					"source" : [ "obj-174", 2 ]
				}
