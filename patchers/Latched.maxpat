...
, 			{
				"box" : 				{
					"comment" : "(anything) Latched value",
					"id" : "obj-5",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 30.0, 101.0, 22.0 ],
					"text" : "receive ---latched"
				}
...
, 			{
				"box" : 				{
					"comment" : "(anything) Value of parameter #1",
					"id" : "obj-4",
					"index" : 1,
					"maxclass" : "outlet",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"comment" : "(bang) Output latched parameter - if changed",
					"cool" : 1,
					"id" : "obj-3",
					"index" : 2,
					"maxclass" : "inlet",
